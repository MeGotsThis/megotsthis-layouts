(function() {
  ...
  class LiveSplitSplit extends LiveSplitIndexableSplit {
      ...
      return {
        index: {
          ...
          computed: 'computeActualIndex(_liveSplit, visibleIndex, ' +
              'scrollOffset, numVisibleSplits, numLastSplits, lookAhead)',
        },
        visibleIndex: {
          type: Number,
        },
    ...
    scrollUp() {
      let {_liveSplit, scrollOffset, numVisibleSplits, numLastSplits,
          lookAhead} = this;
    ...
    computeActualIndex(
        _liveSplit, visibleIndex, scrollOffset, numVisibleSplits, numLastSplits,
        lookAhead) {
      if (!_liveSplit) {
        return undefined;
      }
      ...
      if (visibleIndex < numVisibleSplits - numLastSplits) {
