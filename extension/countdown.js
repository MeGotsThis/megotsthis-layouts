...
const time = nodecg.Replicant('countdown', {
  defaultValue: new TimeObject(120),
  persistent: false,
});
 ...
 * @param {string} startTime - A formatted time string, such as 1:00 for
 *    one hour.
 * @return {undefined}
 */
...
/**
 * Ticks the countdown timer down by one second, stopping the timer if it
 *    hits zero.
 * @return {undefined}
 */
function tick() {
